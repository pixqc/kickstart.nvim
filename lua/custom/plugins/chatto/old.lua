  ...
  vim.schedule(function()
    ...
    for i, line in ipairs(lines) do
      if i == 1 then
        ...
        vim.api.nvim_buf_set_lines(state.bufnr, line_num - 1, line_num, false, { last_line .. line })
      else
        vim.api.nvim_buf_set_lines(state.bufnr, -1, -1, false, { line })
      end
    end
  end)
end
